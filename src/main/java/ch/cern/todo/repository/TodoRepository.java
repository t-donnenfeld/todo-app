...
public interface TodoRepository extends JpaRepository<TodoModel, Long> {
    ...
    @Query("SELECT todo FROM TodoModel todo " +
            "WHERE (:id is null or todo.id=:id)" +
            ...
            "AND (:categoryIs is null or (todo.category is not null and todo.category.name = :categoryIs))" +
            "AND (:usernameIs is null or todo.user.username = :usernameIs)")
